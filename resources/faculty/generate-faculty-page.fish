...
function faculty_page
  ...
  echo ""
  echo "Note: some users in this list might be duplicated / not really 'people', it's simply based on all users within the faculty directory using [this](https://github.com/MUNComputerScienceSociety/Website/blob/master/content/resources/faculty/generate-faculty-page.fish) script."
  echo ""
